-- Multi-institute Phase 4 security hardening.
-- Account-management RPCs may not mutate the caller's own institute membership.
...
begin
  ...
  select id into v_role_id from public.institute_roles where institute_id = p_institute_id and role_key = p_role_key and status = 'active' limit 1;
