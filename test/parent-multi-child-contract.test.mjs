...
must(/const childTimetable = useMemo\([\s\S]{0,2500}?timetable\s*\.filter\([\s\S]{0,600}?childBatchIds\.has/, "Timetable must be scoped to the selected child's active batches");
