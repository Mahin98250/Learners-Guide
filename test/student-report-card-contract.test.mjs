...
test("student report card is a dedicated print document", () => {
  for (const label of ["Student Report Card", "Student Name", "Academic Performance", "Assessment History", "Attendance", "Homework", "Leave Record", "Overall Performance", "Teacher / Institute Remarks", "Class / Subject Teacher", "Parent / Guardian", "Institute / Administrator"]) {
