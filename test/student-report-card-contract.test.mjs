...
test("student report card is a dedicated print document", () => {
  for (const label of ["Student Academic Report", "Student Information", "Academic Performance", "Examination Results", "Attendance", "Homework", "Leave Record", "Overall Performance", "Teacher / Institute Remarks", "Class Teacher", "Parent / Guardian", "Institute / Admin"]) {
