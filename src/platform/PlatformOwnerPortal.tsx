...
export default function PlatformOwnerPortal(){
 ...
 const openSettings=()=>{setProduct(settings?.product_name||"Learner's Guide");setLegal(settings?.legal_name||"");setWebsite(settings?.public_website_url||"");setAppDomain(settings?.default_app_domain||"");setSupport(settings?.support_email||"");setTimezone(settings?.default_timezone||"Asia/Kolkata");setSettingsOpen(true)};
