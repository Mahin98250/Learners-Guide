...
if (studentStart >= 0 && teacherStart > studentStart) {
  ...
  const body = source.slice(studentStart, teacherStart)
    .replaceAll('pass: "1234"', 'pass: "Student@1234"')
    .replaceAll("parent@1234", "Parent@1234")
    .replace('placeholder="Default: 1234"', 'placeholder="Default: Student@1234"');
...
if (teacherStart >= 0 && teacherEnd > teacherStart) {
  ...
  const body = source.slice(teacherStart, teacherEnd)
